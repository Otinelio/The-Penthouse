...
const MENU_ITEMS = [
  ...
  { id: "s2", category: "signature", name: "Obsidian Mule", description: "Black vodka, ginger beer, activated charcoal, lime", price: 9e3 },
  ...
  { id: "s5", category: "signature", name: "Monstera Fizz", description: "Midori, cucumber, elderflower, sparkling water", price: 8e3 },
  { id: "c1", category: "classic", name: "Mojito", description: "White rum, mint, lime, sugar, soda", price: 7e3 },
  ...
  { id: "c4", category: "classic", name: "Whisky Sour", description: "Bourbon, lemon, sugar, egg white foam", price: 8e3 },
  ...
  { id: "m3", category: "mocktails", name: "Golden Hour", description: "Passion fruit, turmeric, honey, sparkling water", price: 5e3 },
  { id: "t1", category: "tapas", name: "Tuna Tataki", description: "Sesame-crusted seared tuna, ponzu, microgreens", price: 12e3 },
  { id: "t2", category: "tapas", name: "Wagyu Crostini", description: "Thin-sliced wagyu, truffle mayo, brioche toast", price: 15e3 },
  { id: "t3", category: "tapas", name: "Burrata & Heirloom Tomato", description: "Olive oil, basil oil, sea salt, sourdough", price: 1e4 },
  { id: "t4", category: "tapas", name: "Gambas al Ajillo", description: "Garlic prawns in olive oil, chili, crusty bread", price: 13500 },
  { id: "t5", category: "tapas", name: "Grilled Halloumi", description: "Honey, za'atar, lemon, fresh herbs", price: 9e3 },
  ...
  { id: "d3", category: "desserts", name: "Cheese Selection", description: "3 curated cheeses, honey, crackers", price: 11e3 }
];
const TESTIMONIALS = [
